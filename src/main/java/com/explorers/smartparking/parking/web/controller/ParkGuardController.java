...
public class ParkGuardController {
  ...
  public GenericResponse occupyPlace(
    ...
    return new GenericResponse(
        messages.getMessage("message.parking.occupied", null, request.getLocale()));
  }

  @PutMapping("/makeRoom")
  public GenericResponse makeRoom(
    ...
    return new GenericResponse(
        messages.getMessage("message.parking.dismissed", null, request.getLocale()));
  }
}
