...
public class MvcConfig implements WebMvcConfigurer {
  ...
  public static final List<Locale> SUPPORTED_LOCALES =
      Arrays.asList(DEFAULT_LOCALE, Locale.forLanguageTag("ru"), Locale.forLanguageTag("uk"));

  public static final List<String> RESOURCES = List.of("css", "js", "img", "icons");
  ...
  public MessageSource messageSource() {
    ...
    messageSource.setBasenames("classpath:/messages", "classpath:/validation", "classpath:/pages");
